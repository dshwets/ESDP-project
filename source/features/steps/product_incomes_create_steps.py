...
def step_impl(context):
    ...
    price1.clear()
    price1.send_keys('50')
    total2 = context.behave_driver.find_element_by_id("total-2")
    assert int(qty2.get_attribute('value')) * int(price2.get_attribute('value')) == int(total2.get_attribute('value'))
    price2.clear()
    price2.send_keys('20')
    total1 = context.behave_driver.find_element_by_id("total-1")
    assert int(qty1.get_attribute('value')) * int(price1.get_attribute('value')) == int(total1.get_attribute('value'))
