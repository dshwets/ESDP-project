...
class NoteDeleteTestCase(TestCase):
    ...
    def test_note_delete_unauthorized_get_request(self):
        self.assert_response_status(reverse('aboutguests:note_delete', args=(self.note.id,)), 'get', 302)

    def test_note_delete_unauthorized_post_request(self):
        self.assert_response_status(reverse('aboutguests:note_delete', args=(self.note.id,)), 'post', 302)

    def test_note_delete_authorized_request_no_perm(self):
        self.client.login(username='some_admin', password='pass')
        self.assert_response_status(reverse('aboutguests:note_delete', args=(self.note.id,)), 'get', 403)

    def test_note_delete_authorized_get_request_has_perm(self):
        self.user.user_permissions.add(self.permission)
        self.client.login(username='some_admin', password='pass')
        self.assertTemplateUsed('guest_delete.html')
        self.assert_response_status(reverse('aboutguests:note_delete', args=(self.note.id,)), 'get', 200)
    ...
    def test_note_delete_authorized_post_request_has_perm_guest_not_found(self):
        ...
        self.assert_response_status(reverse('aboutguests:note_delete', args=(guest_wrong_id,)), 'get', 404)
